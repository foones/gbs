...
# smart lexer errors
  ...
  'return from function "%s" must return something':
    ...
    'Por ejemplo: return (nroBolitas(Rojo))\n' +
    '             return (42, True)',
  'Main procedure should only return variables':
    'El return del Main sólo puede devolver variables',
...
# smart parser errors
  ...
  'Strings can only be used in a BOOM command':
    'Las cadenas sólo se pueden usar en un comando BOOM.\nPor ejemplo: BOOM("rompiste todo")',
  'BOOM can only accept a string':
    'El comando BOOM sólo acepta cadenas.\nPor ejemplo: BOOM("rompiste todo")',
...
# lint errors
  ...
  'There should be a Main procedure':
    'El programa debería tener un procedimiento Main.',
  # cannot define
 ...
 '%i values are expected':
  ...
  #
  'Index of a repeatWith cannot be a variable: "%s"':
    'El índice de un repeatWith no puede ser una variable: "%s"',
  'Index of a repeatWith cannot be a parameter: "%s"':
    'El índice de un repeatWith no puede ser un parámetro: "%s"',
  #
  'Cannot modify "%s": parameter is immutable':
    'No se puede modificar "%s": es un parámetro',
  'Cannot modify "%s": index of a repeatWith is immutable':
    'No se puede modificar "%s": es el índice de un repeatWith',

  'Nested repeatWith\'s cannot have the same index: "%s"':
    'repeatWith anidados no pueden tener el mismo índice: "%s"',
  #
  'Main procedure cannot have parameters':
    'El procedimiento "Main" no puede tener parámetros',
...
# modules
  ...
  'Cannot import Main procedure': 'No se permite importar el procedimiento Main',
...
# virtual machine
  ...
  'Program has no Main procedure':
    'El programa no tiene procedimiento Main',
...
# misc
  'At': 'En',
  'At:': 'En:',
  'Locals:': 'Valores de las variables:',
  'to': 'hasta',
  'near': 'cerca de',
  'after': 'después de',
  'line': 'línea',
