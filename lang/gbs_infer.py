...
class GbsTypeInference(object):
    ...
    def initialize_def(self, tree):
        ...
        type_decl = tree.children[4]
        if type_decl is not None:
            t = lang.gbs_type.parse_type_declaration(type_decl)
        elif tree.children[0] == 'procedure':
    ...
    def infer_boom(self, tree):
        "Infer types for a BOOM command."
        pass
    ...
    def infer_repeat_with(self, tree):
        ...
        self._infer_expression_check_type(rng.children[1], index_type)
        self._infer_expression_check_type(rng.children[2], index_type)
